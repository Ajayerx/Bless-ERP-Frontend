...
import { customerService, invoiceService, type CustomerDetail, type Invoice, type InvoiceListResponse } from "@/services"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted mt-0.5">Customer since {new Date(customer.creation).getFullYear()}</p>
            </div>
          </div>
              ...
              <CardContent>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted whitespace-pre-line">{customer.primary_address}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
