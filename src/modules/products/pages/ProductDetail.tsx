...
const priceColumns: Column<ItemPriceRow>[] = [
  ...
  { key: "buying", header: "Buying", className: "text-center",
    render: (p) => p.buying ? <Badge variant="success">Yes</Badge> : <Badge variant="default">No</Badge>,
  },
  { key: "selling", header: "Selling", className: "text-center",
    render: (p) => p.selling ? <Badge variant="success">Yes</Badge> : <Badge variant="default">No</Badge>,
  },
