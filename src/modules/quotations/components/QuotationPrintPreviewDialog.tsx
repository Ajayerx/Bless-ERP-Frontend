...
export default function QuotationPrintPreviewDialog({
  ...
  useEffect(() => {
    ...
    const fetchPdf = async () => {
      ...
      try {
        const blob = await quotationService.generatePDF(quotationName, {
          printFormat,
          letterHead,
          language,
        })
  ...
  }, [open, quotationName, printFormat, letterHead, language])
      ...
      <DialogContent hideClose className="max-w-4xl w-full h-[85vh] flex flex-col p-0 gap-0 overflow-hidden">
        ...
        <div className="flex-1 min-h-0">
          ...
          {pdfUrl && (
            <iframe
              src={pdfUrl}
              title={`Print Preview — ${quotationName}`}
