...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-app-bg flex">
      {/* Left - Branding */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative">
          <blockquote className="text-white/90 text-lg font-medium leading-relaxed">
            "A modern business management platform designed for enterprises that
        ...
        >
          ...
          <div className="bg-primary-50 border border-primary-100 rounded-[14px] px-4 py-3 mb-6">
            ...
            <p className="text-xs text-primary-600/70 mt-0.5">
              Use your ERPNext Administrator or user credentials
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label
                htmlFor="email"
                className="block text-sm font-semibold text-body mb-1.5"
              >
                Username or Email
              </label>
              <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-primary-600 text-primary-50 text-sm font-semibold rounded-[12px] hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98]"
            >
              {loading ? (
