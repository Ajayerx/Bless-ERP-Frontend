...
export const SALES_ORDER_FIELD_META: SalesOrderFieldMeta[] = [
  ...
  { fieldname: "contact_phone", readOnly: true, fieldtype: "Small Text" },
  ...
  { fieldname: "shipment_address", dependsOn: "shipping_address_name", fieldtype: "Link" },
  ...
  { fieldname: "update_auto_repeat_reference", dependsOn: "eval: doc.auto_repeat", allowOnSubmit: true, fieldtype: "Check" },
